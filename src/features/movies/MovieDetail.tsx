...
const MovieDetail = () => {
  ...
  useEffect(() => {
    ...
    const fetchMovies = async () => {
      try {
        ...
        // Don't redirect for 401 errors - handled globally
  ...
  const openModal = () => {
    if (
      ...
      console.warn("Please select theater, date, and time first!")
    }
  }
        ...
        <div className='movieLeft'>
          ...
          <div>
            ...
            <div className='dates-container-wrapper'>
              ...
              <div className="dates" ref={datesContainerRef} style={Object.keys(dateTimeMap).length === 0 ? { justifyContent: 'center' } : {}}>
                {Object.keys(dateTimeMap).length === 0 ? (
